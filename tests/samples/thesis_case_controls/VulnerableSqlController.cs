...
// DESCRIPTION: Consulta SQL construida por concatenacion para medir deteccion real
// =============================================================
...
namespace Tests.Samples.ThesisCaseControls
{
    ...
    public class VulnerableSqlController : ControllerBase
    {
        ...
        public IActionResult GetUser()
        {
            ...
            var filter = id + suffix;
            var sql = "SELECT Id, Name, Email FROM Users WHERE Id = '" + filter + "'";
